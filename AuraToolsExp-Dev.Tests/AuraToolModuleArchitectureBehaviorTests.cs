...
internal static partial class AuraToolsTestSuite
{
    ...
    {
        Assert(AuraToolModuleIds.Persisted.Length == 23
               && AuraToolModuleIds.Persisted.Distinct(StringComparer.Ordinal).Count() == 23
               && AuraToolModuleIds.Persisted.Contains(AuraToolModuleIds.FeastCg)
               && AuraToolModuleIds.Persisted.Contains(AuraToolModuleIds.EventCg)
            ...
            "tool module config inventory contains twenty-three unique persisted modules while the strategy lab remains a view over auto-battle configuration");
