...
void TestRuntimeArchitectureGuards()
{
    ...
    Assert(autoBattleSimulationRuntime.Contains("CombatCampaignRunner", StringComparison.Ordinal)
           ...
           && autoBattleModelRuntime.Contains("FoundationAcceptanceKind", StringComparison.Ordinal)
           && autoBattleModelRuntime.Contains("ValidFoundationAcceptance", StringComparison.Ordinal)
