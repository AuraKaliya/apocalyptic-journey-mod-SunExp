...
public sealed partial class NativeRewardScriptGlobals
{
    ...
    internal const int PrecompiledProgramCount = 498;
        ...
        try
        {
            switch (key)
            {
                ...
                case "B4CD74976FFAA642A267BD69303833FF8A04289E6883F10A67B17CDC57C4EF52":
                    ...
                    message = "";
                    return true;
                case "B52D969E686ABA859A6B0A21346856874A23A56663EFE9E23A0DEF3C7D422628":
                    NativeProgram_0344();
                    message = "";
                    return true;
    ...
    {
        SetStatus("Self");int a=CheckDice.Roll().Value;if(a<90){ChangePower("1");}else{ChangeMoney("200");}
    }
