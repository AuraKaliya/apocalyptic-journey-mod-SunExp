...
public sealed partial class NativeRewardScriptGlobals
{
    ...
    internal const int PrecompiledProgramCount = 550;
        ...
        try
        {
            switch (key)
            {
                ...
                case "D4A1D878CFCF24E5A947E376ED324E302DC43EEB00EE495164C7F62EF8211A38":
                    ...
                    message = "";
                    return true;
                case "D53438AE1BCC33162ECCCC7F9DF8A0394985FE26B2CA8B2DD10A3A4D85F197CA":
                    NativeProgram_0445();
                    message = "";
                    return true;
    ...
    private void NativeProgram_0445()
    {
        if (DeckCard == null || DeckCard.Count == 0)
                ...
                PackToDeckAction("1", DeckCard.Select(x => x.dataConfig).ToList(), (list) =>
                {
                    ...
                    PlayerInfo.ShowItemShowUI(newData.data["Icon"],newData.data.Localize("Name"),newData.data.Localize("Description"));
