...
Assert-Contains $cardFrameEffectApplier "frame-mesh-unified-overlay" "Card-frame mesh effects must route through the unified overlay path."
...
Assert-NotContains $cardFrameEffectMaterials "ApplyOverlayMode(" "Card-frame overlay materials must preserve registry-controlled overlay mode."
Assert-NotContains $cardFrameEffectMaterials "ApplyFrameOnlyOverlay(material, false)" "Card-frame overlay materials must preserve registry-controlled frame-only masking."
