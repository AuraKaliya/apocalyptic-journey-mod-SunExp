...
Assert-Contains $cardVisualEffectApi "RegisterFrameEffect" "Card visual effects must keep the legacy frame-target convenience API as a face alias."
...
Assert-Contains $cardVisualEffectApi "SunExpIds.StellarOvertureCardIds" "SunExp default card visual effect must bind Stellar Overture stardust to explicit card ids."
