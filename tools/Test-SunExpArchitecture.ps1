...
Assert-Contains $dimensionShopNativeSkin "nativeItem.Init(new DataConfig(item.Id, type))" "Dimension shop offers must let ShopItem initialize native card/relic visuals and tooltips."
...
Assert-Contains $spiritOtherObj "SpiritIntentPresentationDataComposer.Compose(source.data, presentationAdapterData)" "Spirit runtime action cards must compose source visuals with the registered adapter identity."
