...
Assert-Contains $familiarGrowthPanel '"确认重生"' "Familiar growth UI must require an explicit rebirth confirmation."
Assert-NotContains $familiarGrowthPanel '"登记同类"' "Familiar growth UI must not create duplicate bodies."
