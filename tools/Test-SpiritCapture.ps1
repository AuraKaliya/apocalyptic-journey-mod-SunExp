...
Assert-True ($identityResolverSource.Contains('BaseGameRuntimePrefix = "enemy_"') -and $identityResolverSource.Contains('TerriasRuntimePrefix = "Terrias_terrias_"')) "spirit identity resolution must cover base-game and Terrias runtime prefixes."
