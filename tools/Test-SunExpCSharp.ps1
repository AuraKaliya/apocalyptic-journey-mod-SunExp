...
function Invoke-SourceAssertions {
    ...
    Assert-True ($enemyCardText.Contains("enemycard_saint_purification,,") -and $enemyCardText.Contains("Saint Prayer")) "Saint purification enemy-card text must use Saint Prayer."
    Assert-True ($enemyCardText.Contains("enemycard_saint_return_to_court,,") -and $enemyCardText.Contains("Time Engraving")) "Saint return enemy-card text must use Time Engraving."
