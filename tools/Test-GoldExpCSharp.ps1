...
Assert-True $cards.Contains("UnityEngine.Random.value < 0.5f") "Fortune Throw must roll a 50% damage chance."
Assert-True $cards.Contains('ExecutorApi.DealDamageRandomEnemy(self, 3, "True");') "Fortune Throw must deal 3 true damage on success."
