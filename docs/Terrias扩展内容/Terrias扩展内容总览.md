...
- 版本：Terrias `0.5.0`；游戏构建 `1.0.23816797`；运行时表导出 `witch-tables-20260729-041006.json`（2026-07-29）。
...
| 桑多涅喵 | `Terrias_terrias_sandrone_cat` | 哥！伦！比！娅！（`Terrias_terrias_sandrone_cat_placeholder`） | 战斗开始时，减少3+2%最大生命值上限，战斗结束时，增加2+3%最大生命值上限。 |
...
| 卡包 | 运行时 ID | 卡牌数 | 定位 |
|---|---|---:|---|
| 【日耀：星火】 | `Terrias_terrias_cardpack_radiant_spark` | 13 | 【日耀：星火】基础卡包。提供日耀、聚炎、烬衣与圣冕入口，并保留低复杂度的灼烧转换。 |
| 【日耀：烬冠】 | `Terrias_terrias_cardpack_ember_crown` | 9 | 【日耀：烬冠】扩展卡包。围绕自身灼烧、聚炎叠层与圣冕爆发展开，需要管理自燃压力。 |
| 【日耀：天幕】 | `Terrias_terrias_cardpack_solar_canopy` | 8 | 【日耀：天幕】扩展卡包。围绕炽灼天幕、敌方灼烧、负面状态与持续扩散展开。 |
...
| `Terrias_terrias_afterglow_omen_card` | 圣庭净裁 | 技能牌 | 3 | 5 | 消除目标除{buff_burn}和{Terrias_terrias_body_burn}外的所有 Buff，每消除一种，给予目标1层{buff_burn}。 |
...
| `Terrias_terrias_sandrone_cat_trait` | 哥！伦！比！娅！ | 2 | 1 | 0／0／0 | 战斗开始时，减少3+2%最大生命值上限，战斗结束时，增加2+3%最大生命值上限。 |
...
|---|---|---:|---|---|
| `Terrias_terrias_blazing_sundial` | 曜阳日晷 | 1 | 【日耀：天幕】 | 回合开始时，至多4名带有{buff_burn}的敌人获得1层{buff_weak}和1层{buff_rotten}。 |
| `Terrias_terrias_ember_cloak_lining` | 烬衣衬布 | 1 | 【日耀：烬冠】 | 回合开始时，移除1层{buff_burn}，获得2层{Terrias_terrias_gathered_flame}。 |
| `Terrias_terrias_morning_shard` | 晨辉碎片 | 1 | 【日耀：星火】 | 战斗开始时，获得2层{Terrias_terrias_solar_radiance}。 |
| `Terrias_terrias_solar_prism` | 日心棱镜 | 1 | 【日耀：星火】 | 战斗开始时，获得1层{Terrias_terrias_solar_radiance}。每回合第一次获得{Terrias_terrias_solar_radiance}后，额外获得1层{buff_elements}。 |
| `Terrias_terrias_burning_calamity_wind_belt` | 燃灾风带 | 2 | 【日耀：天幕】 | 回合开始时，至多4名带有{buff_burn}的敌人各使随机另一名敌人获得3层{buff_burn}。 |
| `Terrias_terrias_coronation_throne` | 授冕圣座 | 2 | 【日耀：星火】 | 每场战斗第一次获得{Terrias_terrias_solar_crown}后，抽2张牌并回复2点魔能。 |
| `Terrias_terrias_sun_bottle` | 太阳瓶 | 2 | 【日耀：天幕】 | 回合开始时，随机一名带有{buff_burn}的敌人，其{buff_burn}立刻生效一次。 |
| `Terrias_terrias_sun_orbit_mirror` | 环日镜 | 2 | 【日耀：烬冠】 | 每行动3次，获得1层{Terrias_terrias_gathered_flame}，对随机敌人施加3层{buff_burn}。 |
| `Terrias_terrias_ash_charm` | 灰烬护符 | 3 | 【日耀：烬冠】 | 回合结束时，获得等于自身{buff_burn}层数的{Terrias_terrias_ember}和护盾。 |
| `Terrias_terrias_gathered_flame_charm` | 聚炎护符 | 3 | 【日耀：烬冠】 | 自身{buff_burn}层数增加后，获得等量的{Terrias_terrias_gathered_flame}。 |
| `Terrias_terrias_miniature_sunwheel` | 小型日轮 | 3 | 【日耀：烬冠】 | 回合开始时，获得自身负面 Buff 总层数等量的{Terrias_terrias_gathered_flame}，敌方全体获得你{Terrias_terrias_solar_radiance}层数的{buff_burn}。 |
| `Terrias_terrias_solar_phase_dial` | 日相刻盘 | 3 | 【日耀：星火】 | 回合开始时，根据{Terrias_terrias_solar_radiance}层数最多触发三种效果：4+抽1张牌，8+获得1点魔能，12+全体{buff_burn}立刻生效一次。 |
| `Terrias_terrias_blazing_crown_heart` | 炽冠圣心 | 4 | 【日耀：天幕】 | 战斗开始时，获得8层{Terrias_terrias_solar_radiance}、1层{Terrias_terrias_solar_crown}，为场地铺上2层{Terrias_terrias_scorching_canopy}。 |
...
| 祝福 ID | 名称 | 类型 | 稀有度 | 效果 |
|---|---|---|---:|---|
| `Terrias_terrias_origin_fortune_50` | 幸运·本源升华 | 本源超凡 | 3 | 幸运达到50：检定骰与数值骰获得50点加成；达到150点数时，额外触发2次。 |
| `Terrias_terrias_origin_perceive_50` | 感知·本源升华 | 本源超凡 | 3 | 感知达到50：每场战斗结束后，生命值恢复至上限。 |
| `Terrias_terrias_origin_spirit_50` | 精神·本源升华 | 本源超凡 | 3 | 精神达到50：每场战斗开始时，魔能上限提高3点。 |
| `Terrias_terrias_origin_strength_50` | 魔力·本源升华 | 本源超凡 | 3 | 魔力达到50：每场战斗开始时，获得2张附着【绝灭】火漆的【不稳定思绪】。 |
| `Terrias_terrias_dusk_afterheat_recovery` | 余热回收 | 伙伴占位 | 5 | 每当敌人{buff_burn}触发时，获得其{buff_burn}层数1/3的{Terrias_terrias_ember}与{Terrias_terrias_gathered_flame}。 |
| `Terrias_terrias_sandrone_cat_placeholder` | 哥！伦！比！娅！ | 伙伴占位 | 5 | 战斗开始时，减少3+2%最大生命值上限，战斗结束时，增加2+3%最大生命值上限。 |
| `Terrias_terrias_star_clay_doll_placeholder` | 星泥傀身 | 伙伴占位 | 5 | 战斗开始时，获得1层{Terrias_terrias_star_clay_body}。每次行动后，获得1层{Terrias_terrias_starlight}。 |

### 火漆（2 条）

| 火漆 ID | 名称 | 稀有度 | 效果 |
|---|---|---:|---|
| `Terrias_terrias_morning_star_seal` | 启明星 | 3 | 附着卡打出后，根据实际支付费用获得等量{Terrias_terrias_star_blessing}。 |
| `Terrias_terrias_solar_keyword` | 白曜 | 2 | 附着卡获得“白曜”。 |
...
| 精灵系统 | 使用精灵球按目标已损失生命检定捕获，成功后生成可持久化精灵卡；战斗中精灵与投影共用召唤位。 | [精灵球捕获与精灵召唤](../Terrias/modules/08-精灵球捕获与精灵召唤.md) |
