...
| 工具控制层 | `AuraToolsExp-Dev/Features/AutoBattle/` | 设置生效、战斗按钮、单动作控制循环、超时和训练样本落盘 |
...
- 当前没有完整敌方意图、未来伤害、牌堆概率和多回合搜索模型。
- 短期奖励只比较动作前后生命、护盾、能量和敌方生命，不能直接代表整局胜率。
