...
| 可选媒体扩展 | Terrias voice/CG discovery manifests；AuraToolsExp skin/card-visual/tool defaults | AuraTools discovery、voice/CG/skin/card-visual modules | AuraAudio/Cg/Skin、Audio/BGM arbiters、Core discovery/package | 共享动作/语音信号、Unity Audio/AssetBundle、共享注册协议 | 模块 12 | P1 |
