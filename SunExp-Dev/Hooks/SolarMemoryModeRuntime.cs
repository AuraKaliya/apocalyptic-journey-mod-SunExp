...
public static class SolarMemoryModeRuntime
{
    ...
    private static void EnsureSolarMemoryMapBeforeSelect(ModHookContext context)
    {
        try
        {
            ...
            if (mapManager?.ModeMapManager is NormalMapManager manager)
            {
                ...
                TryContinuePendingSaintWunaBoss("MapSelectUI.ReadyToSelect");
            }
        }
        catch (Exception ex)
        {
    ...
    internal static void ReapplySolarMemoryFixedSlotLocks(ModHookContext context)
    {
        try
        {
            ...
            TryContinuePendingSaintWunaBoss("MapSelectUI.ShowMap");
        }
        catch (Exception ex)
        {
    ...
    private static void FinishSolarMemoryAfterFinalLayer(ModHookContext context)
    {
        try
        {
            ...
            if (solarMemoryStorySettlementPending)
            {
    ...
    {
        solarMemoryStorySettlementPending = false;
        CompleteSolarMemoryRunForSettlement(source);
    }
    ...
    private static bool TryContinuePendingSaintWunaBoss(string source)
    {
    ...
    private static void RepairSaintWunaBossSyncArrays(MapManager mapManager)
    {
        ...
        RepairSolarMemoryMapArrays(maps, mapData);
    ...
    private static void CloseSolarMemoryBossTransitionUi(string source)
    {
        try
        {
            CloseSolarMemoryTransientUi(source);
    ...
    private static void ClearPendingSaintWunaBossFlow()
    {
        solarMemorySaintWunaBossTransitioning = false;
