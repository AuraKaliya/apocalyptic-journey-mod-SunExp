...
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- | --- |
| SunExp_sunexp_spark | 星火 | Spark | 攻击牌 | 1 | 0 | - | Attack | SunExp_sunexp_cardpack_radiant_spark | 造成{0}点伤害。给予目标1层{buff_burn}。获得1层{SunExp_sunexp_solar_radiance}。 |
...
| SunExp_sunexp_ember_cloak_card | 烬衣 | Ember Cloak | 技能牌 | 1 | 0 | - | - | SunExp_sunexp_cardpack_radiant_spark | 清除自身{buff_burn}和{SunExp_sunexp_body_burn}，获得等同于清除层数总和一半的护盾，并获得{SunExp_sunexp_ember_cloak}。 |
...
| SunExp_sunexp_*solar_phase_tuning | 日相校准 | Solar Phase Tuning | 技能牌 | 2 | 1 | - | - | SunExp_sunexp_cardpack_radiant_spark | 获得3层{SunExp_sunexp_solar_radiance}。吸收自身至多6层{buff_burn}，转化为等量{SunExp_sunexp_gathered_flame}。若吸收满6层，抽1+日耀层数/3张牌。 |
...
| SunExp_sunexp_eclipse_hex | 蚀天之咒 | Eclipse Hex | 攻击牌 | 2 | 2 | - | Attack | SunExp_sunexp_cardpack_solar_canopy | 若目标敌人没有{buff_burn}，对其施加6层{buff_burn}；否则对其施加等同于当前层数的{buff_burn}。随后目标的{buff_burn}立即生效一次。 |
| SunExp_sunexp_*solar_scorching_light | 日耀灼光 | Solar Scorchlight | 攻击牌 | 1 | 1 | - | Attack | SunExp_sunexp_cardpack_ember_crown | 造成{0}点伤害。伤害为8+目标{buff_burn}层数*X，X为自身{SunExp_sunexp_gathered_flame}层数/4，至少为1。 |
...
| SunExp_sunexp_*solar_origin_core | 日耀源核 | Solar Origin Core | 能力牌 | 2 | 1 | Burnout | - | SunExp_sunexp_cardpack_radiant_spark | 获得{SunExp_sunexp_origin_core_radiance}。 |
...
| SunExp_sunexp_solar_eclipse | 日蚀 | Solar Eclipse | 技能牌 | 1 | 1 | - | - | SunExp_sunexp_cardpack_solar_canopy | 敌方全体获得2层{buff_burn}和1层{buff_weak}，若场上存在{SunExp_sunexp_scorching_canopy}，则额外施加1层{buff_weak}和1层{buff_rotten}。 |
...
| SunExp_sunexp_*afterglow_omen_card | 残光病兆 | Afterglow Omen | 能力牌 | 2 | 2 | Burnout | - | SunExp_sunexp_cardpack_solar_canopy | 获得{SunExp_sunexp_afterglow_omen}。 |
...
| SunExp_sunexp_ember_cloak | 烬衣 | Ember Cloak | 能力 | 1 | 1 | FALSE | 获得时清除自身灼烧，下回合开始时再次清除自身灼烧，然后移除此状态。 |
